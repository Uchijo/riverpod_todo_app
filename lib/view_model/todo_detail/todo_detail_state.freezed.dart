...
class _$TodoDetailStateTearOff {
  ...
  _TodoDetailState call({Todo? focusedTodo}) {
...
mixin _$TodoDetailState {
  Todo? get focusedTodo => throw _privateConstructorUsedError;
...
class _$TodoDetailStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      focusedTodo: focusedTodo == freezed
          ? _value.focusedTodo
  ...
  @override
  $TodoCopyWith<$Res>? get focusedTodo {
    if (_value.focusedTodo == null) {
      return null;
    }

    return $TodoCopyWith<$Res>(_value.focusedTodo!, (value) {
      return _then(_value.copyWith(focusedTodo: value));
    });
  }
}
...
class _$_TodoDetailState
    with DiagnosticableTreeMixin
    implements _TodoDetailState {
  _$_TodoDetailState({this.focusedTodo});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TodoDetailState(focusedTodo: $focusedTodo)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'TodoDetailState'))
      ..add(DiagnosticsProperty('focusedTodo', focusedTodo));
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.focusedTodo, focusedTodo));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(focusedTodo));
...
abstract class _TodoDetailState implements TodoDetailState {
  factory _TodoDetailState({Todo? focusedTodo}) = _$_TodoDetailState;
